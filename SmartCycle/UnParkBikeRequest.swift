//
//  UnParkBikeRequest.swift
//  SmartCycle
//
//  Created by Joao Duarte on 18/08/2017.
...
class UnParkBikeRequest {
    ...
    func execute(userId: String, parkId: String, _ callback: @escaping (Bool, Error?) -> Void) {
        ...
        let serviceUrl = String(format:"%@bike/unpark", Constants.Urls.SmartcycleAPIUrl)
        ...
        let parameters = ["user_id": userId, "park_id": parkId] as [String: Any]
